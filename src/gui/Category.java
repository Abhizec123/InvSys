    ...
    private void initComponents() {
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addComponent(t4, javax.swing.GroupLayout.PREFERRED_SIZE, 299, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        (null, "Do you really want to delete?", "Confirmation", JOptionPane.YES_NO_OPTION);
            ...
            if(r==JOptionPane.YES_OPTION)
            {
                ...
                try
                {
                    db.DbConnect.s.executeUpdate("delete from category where catName='"+cat+"' ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            if(!c.equals(""))
            {
                ...
                String sql="insert into category values ('"+c+"')";
